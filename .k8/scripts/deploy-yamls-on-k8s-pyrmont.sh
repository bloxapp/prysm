...
#deploy pyrmont
kubectl --context=$K8S_CONTEXT apply -f .k8/yamls/prysm_pyrmont_health_check_cm.yml || exit 1
kubectl --context=$K8S_CONTEXT apply -f .k8/yamls/prysm_pyrmont_deployment.yml || exit 1
