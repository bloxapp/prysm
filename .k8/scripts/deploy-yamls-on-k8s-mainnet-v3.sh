...
#deploy pyrmont
kubectl --context=$K8S_CONTEXT apply -f .k8/yamls/prysm_mainnet_health_check_cm_v3.yml || exit 1
kubectl --context=$K8S_CONTEXT apply -f .k8/yamls/prysm_mainnet_deployment_v3.yml || exit 1
