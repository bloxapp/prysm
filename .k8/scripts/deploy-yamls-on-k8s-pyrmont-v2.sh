...
#secure namespace
  ...
  #for file in $(ls -A1 .k8/psp/); do
  #  sed -i -e "s|REPLACE_NAMESPACE|${NAMESPACE}|g" .k8/psp/${file} || exit 1
  #done
...
#deploy pyrmont
kubectl --context=$K8S_CONTEXT apply -f .k8/yamls/prysm_pyrmont_health_check_cm_v2.yml || exit 1
kubectl --context=$K8S_CONTEXT apply -f .k8/yamls/prysm_pyrmont_deployment_v2.yml || exit 1
